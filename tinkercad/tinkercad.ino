...
  { "Sous-sol " , '*', -1, false,  1,  0,   84,   -1,   0 },
  { "RDC       ", '0',  0, true , 3, 2,  101,   93,   0 },
  { "1er etage", '1',  1, false, 5, 4,  118,  110,   0 },
  { "2e etage ", '2',  2, false, 7, 6,  135,  127,   0 },
  { "3e etage ", '3',  3, false, 9, 8,  152,  144,   0 },
  { "4e etage ", '4',  4, false, 11, 10,  169,  161,   0 },
  { "5e etage ", '5',  5, false, 13, 12,  186,  178,   0 },
  { "6e etage ", '6',  6, false, 15, 14,  203,  195,   0 }
};
...
    floor_feedback(cabin_current_floor(), "(PAUSE)        ");
    return;
}
  switch(state) {
    case STATE_OPENED:
